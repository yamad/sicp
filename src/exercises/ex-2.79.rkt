...
The goal is to define a generic equality predicate @racket[equ?].

First, we define the generic operation to test equality of two numbers

@chunk[<equ?-generic-operation>
(define (equ? a b) (apply-generic 'equ? a b))
]

This goes in the scheme number package

@chunk[<equ?-scheme-number>
(put 'equ? '(scheme-number scheme-number) equal?)
]

Likewise, for the other packages

@chunk[<equ?-rational-number>

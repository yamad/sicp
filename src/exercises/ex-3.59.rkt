...
;; Exercise 3.59: In section *Note 2-5-3:: we saw how to implement a
...
;;
;;                            1             1             1
;;               c + a_0 x + --- a_1 r^2 + --- a_2 r^3 + --- a_3 r^4 + ...
;;                            2             3             4
;;
...
(define (integrate-series series)
  (mul-streams unit-fractions series))

...
(define LEVEL-REAL          3)
(define LEVEL-COMPLEX-POLAR 4)
(define LEVEL-COMPLEX-RECT  5)
(define LEVEL-POLY          6)
...
(define (install-complex-package)
  ...
  (put 'tower-level '(complex) tower-level)
  ...
  (define (install-rectangular-package)
    ...
    (put 'make-from-mag-ang '(rectangular)
         (lambda (r a) (tag (make-from-mag-ang r a))))
    (put 'tower-level '(rectangular) (lambda (x) LEVEL-COMPLEX-RECT))
    'done)
  ...
  (define (install-polar-package)
    ...
    (put 'make-from-mag-ang '(polar)
         (lambda (r a) (tag (make-from-mag-ang r a))))
    (put 'tower-level '(polar) (lambda (x) LEVEL-COMPLEX-POLAR))
    'done)

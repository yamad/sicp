...
To implement subtraction on polynomials, we first implement (as
suggested) a generic negation operation:

@chunk[<negate-op>
(define (negate n) (apply-generic 'negate n))
]

@chunk[<negate-scheme-number>
(put 'negate '(scheme-number)
     (lambda (x) (tag (- x))))
]

@chunk[<negate-rational>
(put 'negate '(rational)
     (lambda (x)
...
Once @racket[negate] works, it is easy to implement subtraction for
polynomials.
